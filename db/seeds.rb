...
plant1 = Plant.new(name: "Mandarin", description:"", categories:"fruit")
...
plant2 = Plant.new(name: "litchee", description:"", categories:"fruit")
...
plant3 = Plant.new(name: "star fruit", description:"", categories:"fruit")
...
plant4 = Plant.new(name: "longan", description:"", categories:"fruit")
...
plant5 = Plant.new(name: "aplpe", description:"", categories:"fruit")
...
plant6 = Plant.new(name: "pommegrenade", description:"", categories:"fruit")
...
plant7 = Plant.new(name: "strawberry", description:"", categories:"fruit")
...
plant8 = Plant.new(name: "water melon", description:"", categories:"fruit")
...
plant9 = Plant.new(name: "Pinapple", description:"", categories:"fruit")
...
plant10 = Plant.new(name: "pear", description:"", categories:"fruit")
...
plant11 = Plant.new(name: "grape", description:"", categories:"fruit")
...
plant12 = Plant.new(name: "potato", description:"", categories:"vegetable")
...
plant13 = Plant.new(name: "cocumber", description:"", categories:"vegetable")
...
plant14 = Plant.new(name: "cabbage", description:"", categories:"vegetable")
...
plant15 = Plant.new(name: "lettuce", description:"", categories:"vegetable")
...
plant16 = Plant.new(name: "Carrots", description:"", categories:"vegetable")
...
plant17 = Plant.new(name: "Capcicum", description:"", categories:"vegetable")
...
plant18 = Plant.new(name: "Eggplant", description:"", categories:"vegetable")
plant19.photo.attach(io: file, filename: "Eggplant.jpg", content_type: "image/jpg")
plant18.save
...
plant19 = Plant.new(name: "spinach", description:"", categories:"vegetable")
...
plant24 = Plant.new(name: "Jasmin", description:"", categories:"flower")
...
plant25 = Plant.new(name: "White Roses", description:"", categories:"flower")
...
plant26 = Plant.new(name: "Red Roses", description:"", categories:"flower")
